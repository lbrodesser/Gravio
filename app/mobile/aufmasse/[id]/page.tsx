  ...
  return (
    <div className="flex flex-col h-full">
      <header className="sticky top-0 z-10 bg-background border-b border-border px-4 h-16 flex items-center gap-3 shrink-0">
        ...
        <h1 className="text-lg font-semibold flex-1 truncate">{baustelle?.name ?? 'Aufmaße'}</h1>
...
function AufmassListItem({ aufmass, onDelete, isDeleting }: { aufmass: Aufmass; onDelete: () => void; isDeleting: boolean }): React.JSX.Element {
